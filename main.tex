...
\newcommand{\Convocatoria}{(Convocatoria en la que se presenta)}
% Datos del autor
...
% Universidad
\definecolor{rojoUM}{RGB}{224,59,35}	% RojoUM
\definecolor{azulUM}{RGB}{0,32,40}	% AzulUM
\definecolor{blancoUM}{RGB}{237,233,227}	% BlancoUM
\definecolor{metalicoUM}{RGB}{140,144,147}	% MetalicoUM
%Informatica
\definecolor{azulFIUM}{RGB}{0,114,206} %AzulFIUM
% Colores generales
\definecolor{negro}{RGB}{0,0,0}
\definecolor{blanco}{RGB}{255,255,255}

% Logotipos comunes de todas las titulaciones
\newcommand{\logoFacultadPortada}{include/logos-titulaciones/SelloFIUM-negativo}
\newcommand{\logoGradoPortada}{include/logos-titulaciones/Simbolo-negativo-sin-fondo} 
\newcommand{\logoUniversidadPortada}{include/logos-universidad/SelloUM-negativo}
\newcommand{\logoFacultadPortadaBaja}{include/logos-titulaciones/LogoFIUM-Horizontal-Blanco}
% Logos
\newcommand{\logoGrado}{include/logos-titulaciones/FI-positivo}
\newcommand{\logoGradoConvivenciaNegro}{include/logos-titulaciones/Convivencia-FIUM-UM-negro}
\newcommand{\logoGradoConvivenciaColorPositivo}{include/logos-titulaciones/Convivencia-FIUM-UM-color-positivo}
...
% Color
\newcommand{\colorAzulUM}{azulUM}
\newcommand{\colorRojoUM}{rojoUM}
\newcommand{\colorBlancoUM}{blancoUM}
\newcommand{\colorMetalicoUM}{metalicoUM}
\newcommand{\colorAzulFIUM}{azulFIUM}
